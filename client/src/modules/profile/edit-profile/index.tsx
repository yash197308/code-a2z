...
const EditProfile = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    updateProfile(username, bio as string, youtube as string, facebook as string, twitter as string, github as string, instagram as string, website as string)
      .then((response) => {
            ...
            <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
              ...
              <div className="w-full">
                ...
                <div className="md:grid md:grid-cols-2 gap-x-6">
                  ...
                  {
                    (Object.keys(social_links) as Array<keyof typeof social_links>).map((key, i) => {
